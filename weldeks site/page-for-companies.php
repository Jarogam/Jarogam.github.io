    ...
    <section class="hero-banner">
        <div class="container mx-auto">
            <div class="hero-banner__wrapper md:mt-52">
                <h1 class="main-color md:text-6xl text-4xl font-bold">For companies</h1>
                <p></p>
            </div>
        </div>
    </section>
    <section class="work-in py-36 pb-20">
        <div class="container mx-auto">
                <h2 class="text-center wdks_title">
                    <?php echo esc_html( get_theme_mod( 'companies_settings_text_1' ) ); ?>
                </h2>
                <p class="text-center mt-6 color-text__grey text-lg">
                    <?php echo esc_html( get_theme_mod( 'companies_settings_text_2' ) ); ?>
                </p>
                ...
                <div class="py-5 px-10 shadow-lg mb-4">
                    <details class="group">
                        <summary class="flex justify-between items-center font-medium cursor-pointer list-none">
                            <span class="main-color text-3xl font-normal"> Project manager</span>
                        ...
                        <div class="text-neutral-600 job-accordeon__opened group-open:animate-fadeIn mt-12">
                            <p class="mb-6"><img class="inline-block pr-3" src="/wp-content/themes/weldeks/assets/img/forcandidates/loc.svg" alt="icon"><strong class="main-color">Location:</strong> City</p>
                            ...
                            <ul class="list-disc pl-5 my-2">
                                <li class="my-4">Task 1</li>
                                <li class="my-4">Task 2</li>
                                <li class="my-4">Task 3</li>
                            </ul>
                            ...
                            <p class="mb-16">For skulls give zoom these enable fit. Want container knowledge meat discussion gave. Needle diarize after make heads-up caught work adoption box a. Obviously company social could window seat incentivize by journey good. Resources ipsum feelers manage with first conversation building. Cc lot panel rundown note principles territories.</p>
